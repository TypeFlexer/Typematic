 ...
 */
  ...
  if(!Self.getLangOpts().drymatic && S != nullptr && !((S->isTaintedFunctionScope() || IsTaintedScope)
    ...
    if (!Self.getLangOpts().drymatic && DestType->isPointerType() && (!DestType->isTaintedPointerType())) {
